...
root.geometry('1080x580+300+200')
...
frame_workout_write = ctk.CTkFrame(frame_left)
frame_workout_write.grid(row=1, column=0, padx=(15, 0), pady=15, sticky='nswe')
ctk.CTkLabel(frame_workout_write, text='Write the correct translation:', font=('Areal', 20)).pack(padx=5, pady=(10, 5))
...
show_result_write_label.pack(padx=(20, 20))
...
frame_workout_choice = ctk.CTkFrame(frame_left)
frame_workout_choice.grid(row=1, column=1, padx=15, pady=15)
ctk.CTkLabel(frame_workout_choice, text='Choose the correct translation:', font=('Areal', 20)).pack(pady=(10, 0))
...
frame_right.grid(row=0, column=3, pady=15, padx=(0, 15))
